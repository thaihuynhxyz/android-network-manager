 ...
 * OneoffTask are met.
 */
public class BestTimeJob extends Job {

    static final String TAG = "BestTimeJob";

    @NonNull
    @Override
    protected Result onRunJob(@NonNull Params taskParams) {
        ...
        TaskItem taskItem = CodelabUtil.getTaskItemFromFile(App.getInstance(), taskId);
        if (taskItem == null) {
        ...
        CodelabUtil.saveTaskItemToFile(App.getInstance(), taskItem);
